...
@section('title', 'Thêm chương trình khuyến mãi mới')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control start-picker active" readonly="readonly"
                                            name="sale[start_date]" value="{{ old('sale[start_date]') }}">
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control end-picker active" readonly="readonly"
                                            name="sale[end_date]" value="{{ old('sale[end_date]') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <span class="image img-cover image-target"><img class="w-100"
                                                src="{{ old('sale[image]') ? old('sale[image]') : asset('admin/images/not-found.jpg') }}"
                                                alt=""></span>
                                        <input type="hidden" name="sale[image]" value="{{ old('sale[image]') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
